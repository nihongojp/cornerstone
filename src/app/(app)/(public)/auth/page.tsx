 ...
 *
 * The guard is here rather than in a layout, because a layout is not given
 * `searchParams` — so it could only ever send everyone to the same fixed page,
 * discarding the `from` the proxy had just gone to the trouble of attaching.
 *
